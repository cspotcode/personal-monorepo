...
function factory() {
	...
	function logHelpMessage(generator) {
		console.log(getHelpMessage(generator));
	}

	function chooseOptionFromList(plopList, message) {
		const plop = nodePlop(undefined as TODO);
		...
		return (generator as TODO).runPrompts().then(results => results.generator);
	}

	function displayHelpScreen() {
		console.log(getHelpScreen());
	}
